...
export default function GlutenFreeIcon({ size = 48, className }: GlutenFreeIconProps) {
    return (
        <svg
            width={size}
            height={size}
